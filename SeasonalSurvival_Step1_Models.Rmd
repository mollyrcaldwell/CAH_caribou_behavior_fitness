...
grp <- case_when(
  ...
  str_detect(names(beh_cond_early_aic_mod), "biom_herd") & 
    str_detect(names(beh_cond_early_aic_mod), "avg_biom |avg_dn |resource_vol|avg_biom\\^2") ~ "for_quant",
  str_detect(names(beh_cond_early_aic_mod), "dn_herd|de_herd") & 
    str_detect(names(beh_cond_early_aic_mod), "avg_biom |avg_dn |resource_vol|avg_biom\\^2") ~ "for_qual",
...
beh_cond_early_aic_mod[str_detect(names(beh_cond_early_aic_mod), "avg_de")] <- NULL # remove dig energy use behavior from early summer AIC
...
grp <- case_when(
  ...
  str_detect(names(beh_cond_late_aic_mod), "biom_herd") & 
    str_detect(names(beh_cond_late_aic_mod), "avg_biom |avg_de |resource_vol|avg_biom\\^2") ~ "for_quant",
  str_detect(names(beh_cond_late_aic_mod), "dn_herd|de_herd") & 
    str_detect(names(beh_cond_late_aic_mod), "avg_biom |avg_de |resource_vol|avg_biom\\^2") ~ "for_qual",
...
beh_cond_late_aic_mod[str_detect(names(beh_cond_late_aic_mod), "avg_dn")] <- NULL # remove dig nitrogen use behavior from late summer AIC
